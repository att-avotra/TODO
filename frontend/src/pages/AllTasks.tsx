  ...
  return (
    <section className="py-4 px-8">
      <header>
        ...
        <p>
          You have <span className="">7 high-priority</span> remainings for
          today
        </p>
      </header>
      <div className="px-2 py-2 bg-gray-100 rounded-xl mt-4 flex flex-wrap flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <div className="flex items-center gap-5">
          ...
          <div className="flex items-center gap-2">
            <FilterIcon className="text-gray-600 h-5" />
            <p className="text-md text-gray-600">Sorted by</p>
            <select name="" id="">
      ...
      <TaskList mockData={mockData}></TaskList>
    </section>
  );
}
